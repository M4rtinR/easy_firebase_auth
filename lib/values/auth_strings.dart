...
class AuthStrings {
  ...
  factory AuthStrings.english(
      ...
      weWillSendYouAnEmailToChangePassword =
          "We will send you an email to \$ with instructions on how to change your password",
      emailSentToChangePassword = 'We have sent you an email to \$',
      emailRegisteredEnterPasswordNoticeMarkdown =
      ...
      errorWeakPassword = 'The password should be a minimum of 8 characters and contain at least 1 letter and 1 number.',
      errorInvalidEmail = 'Invalid email',
      errorEmailAlreadyInUse = 'That email is already in use',
      errorWrongPassword = 'Incorrect password',
      errorUserNotFound = 'User with the email address \$ does not exist',
      errorUserDisabled = 'This user\'s account has been disabled',
      errorTooManyRequests =
      ...
      passwordTooShort = "The password should be a minimum of 8 characters and contain at least 1 letter and 1 number.",
      email = "Email",
